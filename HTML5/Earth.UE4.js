...
var Module = {
	...
	UE4_indexedDBVersion: 201904221833, // Bump this number to invalidate existing IDB storages in browsers.
};
...
$(document).ready(function() {
	...
	function withIndexedDB(db) {
		...
		// ----------------------------------------
		// MAIN JS
		var mainJsDownload = fetchOrDownloadAndStore(db, Module.locateFile('Earth.js')).then(function(data) {
